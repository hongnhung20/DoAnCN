...
import com.webstore.app.model.CommentsDto;
import com.webstore.app.model.RatingDto;
...
public class ViewController {
  ...
  @GetMapping("/homepage")
   public ModelAndView home(HttpServletRequest request) {
    ...
    //productRepository.findAll() tra ve tat ca san pham co trong table product
    mv.addObject("products", productRepository.findTop6Products());
...
//  }
  ...
  public ModelAndView single(@PathVariable Long id, HttpServletRequest request) {
    ...
    mv.addObject("product", productRepository.findById(id).get());
    mv.addObject("cates", categoryRepository.findAll());
    mv.addObject("category_givepet",categoryRepository.findAll());
    mv.addObject("productId", id);
    mv.addObject("user", request.getSession().getAttribute("user"));
  ...
  @GetMapping("/view-account/{mail}")
  public ModelAndView viewAccount(@PathVariable String mail, HttpServletRequest request) {
    ModelAndView mv = new ModelAndView("view-account");
    mv.addObject("userRepository",userRepository.findAll());
    return mv;
  }
  @GetMapping("/account")
