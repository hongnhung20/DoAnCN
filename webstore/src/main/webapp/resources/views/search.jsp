...
<html>
    <head>
        <title>Sản Phẩm Trang Sức</title>
        <!-- for-mobile-apps -->
                    ...
                    <div class="col-md-4 products-left">
                        <div class="filter-price animated wow slideInUp" data-wow-delay=".5s">
                            ...
                            <ul class="dropdown-menu1">
                                <li>
							<form action="/shop/product/locgia" method="get">
								<div class="slidecontainer">
									<p class="rangeloc">
										<span>Từ : </span><span id="valuegiatu"></span><span> VNĐ</span>
										<!-- <a class="button-33 loc" type="submit" href="/shop/product/loc">Lọc</a> -->
										<input type="submit" class="button-33 loc" value="Lưu">
                ...
                <div class="col-md-8 products-right">
                    <div class="products-right-grid">
                        ...
                        <div class="products-right-grids-position animated wow slideInRight" data-wow-delay=".5s">
                            <img src="/resources/images/slider.png" alt=" " class="img-responsive" />
