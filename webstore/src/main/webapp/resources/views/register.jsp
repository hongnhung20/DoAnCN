            ...
            <div class="register">
                <div class="container">
                    ...
                    <div class="login-form-grids">
                        ...
                        <%}%>
                        	<input type="text" placeholder="Họ và tên"  name="name" id="name" class="name" required="required" >
                         	<input type="text" placeholder="Địa chỉ"  name="diachi" id="diachi" class="diachi" required="required" >
                            <input type="email" placeholder="Email" required name="email" id="email" required="required">
                            ...
                            <script language='javascript' type='text/javascript'>
                            	function checkphone(input){
                            		var regExp = /^(0[35789][0-9]{8}|1[89]00[0-9]{4})$/;
