...
<link href="/resources/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
        ...
        <link rel="stylesheet" href="/resources/css/star-rating.css" type="text/css" media="screen" />
...
<body>
	...
	<div class="container" style="padding-top: 20px;">
			...
			<div class="col-md-5 single-right-left animated wow slideInUp"
				...
				<div class="rating">
					...
					<div class="rating-stars">
						<span class="fa fa-star checked1 checked"></span>
						<span class="fa fa-star checked2 checked"></span>
						<span class="fa fa-star checked3 checked"></span>
						<span class="fa fa-star checked4 checked"></span>
						<span class="fa fa-star checked5 checked"></span>
					</div>
					<div class="rating-users">
						<i class="icon-user"></i>
						<span id="sumtotal">0 đánh giá</span>
					</div>
				</div>
		<c:choose>
					...
					<div class="five histo-rate">
						<span class="histo-star"> <i class="active icon-star"></i>
							5
								...
								<input type="hidden" value="${rs.star5}" id="s5"/>
								<span  id="sao5">${rs.star5}</span>&nbsp;
						</span>
						</span>
					</div>
					...
					<div class="four histo-rate">
						<span class="histo-star"> <i class="active icon-star"></i>
							4
								...
								<input type="hidden" value="${rs.star4}" id="s4"/>
								<span  id="sao4">${rs.star4}</span>&nbsp;
						</span>
						</span>
					</div>
		...
		<%-- 	<div class="fb-comments"
				data-href="http://localhost:8080/shop/single/${productId}"
				data-numposts="3" style="margin-top: 50px"></div>
		...
		<div class="clearfix"></div>
                ...
                <div class="fb-comments" data-href="http://localhost:8080/shop/single/${productId}" data-numposts="3" style="margin-top:50px">
                <jsp:include page="comment.jsp"></jsp:include>
                </div>
                <div class="clearfix"> </div>               
            </div>
