...
<html>
    <head>
        <title>Thế giới trang sức</title>
        <!-- for-mobile-apps -->
		...
		<div class="container">
				...
				<div class="header-grid-left animated wow slideInLeft"
					...
					<ul>
						<li><i class="glyphicon glyphicon-envelope"
							aria-hidden="true"></i> <%-- <% if (user != null){ %>
						...
						<li>
							...
							<a href='/shop/account'>Thông tin tài khoản&nbsp&nbsp&nbsp&nbsp</a>
							<i class="glyphicon glyphicon-book" aria-hidden="true"></i>
							<a href='/shop/logout'>Thoát</a>
						</li>

						<%} else {%>
						<li><i class="glyphicon glyphicon-log-in" aria-hidden="true"></i><a
							href="/shop/login">Đăng Nhập</a></li>
			...
			<div class="logo-nav">
				<div class="logo-nav-left animated wow zoomIn" data-wow-delay=".5s">
					<h1>
						<a href="/shop/homepage">Jewels N<span>Shop anywhere</span></a>
					</h1>
				</div>
						...
						<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
							<ul class="nav navbar-nav">
								...
								<li class="dropdown policy"><a href="#"
									class="dropdown-toggle" data-toggle="dropdown">Chính Sách <b
										class="caret"></b></a>
									<ul class="dropdown-menu multi-column columns-3">
										<div class="row">
											<div class="col-sm-4">
